...
## TypeScript 的特性[§](https://ts.xcatliu.com/introduction/what-is-typescript.html#typescript-的特性)
...
#### TypeScript 是静态类型[§](https://ts.xcatliu.com/introduction/what-is-typescript.html#typescript-是静态类型)
...
#### TypeScript 是弱类型[§](https://ts.xcatliu.com/introduction/what-is-typescript.html#typescript-是弱类型)
...
### 与标准同步发展[§](https://ts.xcatliu.com/introduction/what-is-typescript.html#与标准同步发展)
...
## 附：TypeScript 的发展历史[§](https://ts.xcatliu.com/introduction/what-is-typescript.html#附typescript-的发展历史)
